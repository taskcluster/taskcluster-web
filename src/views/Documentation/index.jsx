...
export default class Documentation extends Component {
  ...
  async handleImport(url) {
    ...
    const doc = url || 'index';
    const isJSON =
      doc.startsWith('reference') &&
      (doc.endsWith('api') || doc.endsWith('events'));
    // docPath is used for docs outside /src/docs
    // e.g., reference/platform/taskcluster-queue/docs/superseding ->
    // taskcluster-queue/docs/superseding
    const docPath = doc
      .split('/')
      .slice(2)
      .join('/');
